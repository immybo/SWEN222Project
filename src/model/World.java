...
public class World implements Storable {
	...
	public static World firstLevel(){
		...
		totem1.setDrawImagePath("images/totemIso.png");
		...
		totem2.setDrawImagePath("images/totemIso.png");
		...
		totemWithItem.setDrawImagePath("images/totemIso.png");
		...
		sign1.setDrawImagePath("images/signIso.png");
		zones[2].addEntity(sign1);
		Furniture sign2 = new Furniture(zones[2],new Coord(new Direction(Direction.NORTH),new Point(7,2)),null,"1 or 2");
		sign2.setDrawImagePath("images/signIso.png");
		zones[2].addEntity(sign2);
		Furniture sign3 = new Furniture(zones[2],new Coord(new Direction(Direction.NORTH),new Point(7,4)),null,"2 or 3");
		sign3.setDrawImagePath("images/signIso.png");
		zones[2].addEntity(sign3);
		zones[2].addItem(new Key(new Point(4,1), "purple"));
		zones[2].addEntity(new KeyGate(Gate.State.LOCKED, zones[2], new Coord(new Direction(Direction.NORTH),new Point(8,1)), "purple"));
		zones[2].addEntity(new KeyGate(Gate.State.LOCKED, zones[2], new Coord(new Direction(Direction.NORTH),new Point(8,3)), "purple"));
		zones[2].addEntity(new KeyGate(Gate.State.LOCKED, zones[2], new Coord(new Direction(Direction.NORTH),new Point(8,5)), "purple"));
		...
		fakePortal1.setDrawImagePath("images/portalIso.png");
		...
		fakePortal2.setDrawImagePath("images/portalIso.png");
		...
		fakePortal3.setDrawImagePath("images/portalIso.png");
		...
		zones[3].addEntity(new KeyGate(Gate.State.LOCKED, zones[3], new Coord(new Direction(Direction.NORTH),new Point(3,6)), "purple"));
		zones[3].addEntity(new KeyGate(Gate.State.LOCKED, zones[3], new Coord(new Direction(Direction.NORTH),new Point(9,6)), "purple"));
